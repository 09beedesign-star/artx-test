  ...
  return (
    <div className="flex flex-col h-screen overflow-hidden" style={{ background: bg, position: "relative", transition: "background 0.25s ease" }}>
      ...
      <div className="flex-1 flex flex-col items-center justify-center gap-4" style={{ position: "relative", zIndex: 1 }}>
        <div className="w-16 h-16 rounded-2xl flex items-center justify-center" style={{ background: "oklch(0.62 0.22 290 / 0.12)" }}>
          <Users size={28} style={{ color: "oklch(0.62 0.22 290)" }} />
        </div>
        <p className="text-[18px] font-semibold" style={{ color: text }}>创作社区</p>
        <p className="text-[13px]" style={{ color: sub }}>即将上线，敬请期待</p>
        <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-full text-[11px]" style={{ background: "oklch(0.62 0.22 290 / 0.10)", color: "oklch(0.62 0.22 290)" }}>
          <Sparkles size={11} />
          Coming Soon
        </div>
      </div>
